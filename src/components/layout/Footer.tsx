export default function Footer() {
  return (
    <footer className="bg-[#FFCCD8]">
      <div className="max-w-[1236px] w-full mx-auto flex justify-between items-center py-[80px]">
        <h1 className="text-[40px] font-black logo">MyUni</h1>

        <div className="flex gap-5 items-center">
          <p className="text-[20px] font-medium">Feel Free to Contact Us:</p>
      ...
      <div className="max-w-[1059px] w-full mx-auto">
        ...
        <div className="flex gap-5 items-center justify-center py-5">
          ...
          <p className="text-base font-medium logo">
